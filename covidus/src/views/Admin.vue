                    ...
                    <v-card v-for="item in tbaData" :key="item._id" class="mx-auto" max-width="500" outlined>
                      <v-list-item three-line>
                        ...
                        <v-list-item-avatar
                          tile
                          size="80"
                        ><v-icon x-large>mdi-face-mask-outline</v-icon></v-list-item-avatar>
                      </v-list-item>
                      <v-card-actions>
...
export default {
    ...
    methods: {
        ...
        approveMaterial(id) {
            axios.post('http://localhost:6969/api/approveMaterial', {
                id: id
            })
            .then(({data}) => {
                if (data.status) {
        ...
        deleteMaterial(id) {
            axios.post('http://localhost:6969/api/deleteMaterial', {
                id: id
            })
            .then(({data}) => {
                if (data.status) {
